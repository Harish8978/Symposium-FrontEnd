...
export default function LandingPage() {
    ...
    return (
        <AnimatedBackground>
            ...
            <div className="flex flex-col items-center justify-center w-full min-h-screen px-6 pt-20 pb-20 md:pb-28">

                <motion.div 
                    key={theme.name} // forces smooth re-render when theme switches
