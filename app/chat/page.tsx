...
import { Send, Skull, Terminal, Sparkles, Wallet, Play } from 'lucide-react';
    ...
    return (
        <AnimatedBackground>
            ...
            <div className="flex flex-col flex-1 h-[calc(100vh-64px)] overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto px-4 py-2 custom-scrollbar">
                    ...
                    {isTyping && (
                        <motion.div
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                            className="mx-4 mb-2 px-4 py-2 rounded-xl self-start inline-block"
                ...
                {/* Input Area */}
                <div
                    className="flex flex-row items-end px-4 py-3 border-t gap-3"
                    style={{ backgroundColor: theme.surface, borderTopColor: theme.surfaceLight }}
                >
                    <textarea
                        value={inputText}
                        ...
                        className="flex-1 min-h-[44px] max-h-[100px] px-4 py-3 rounded-[22px] outline-none text-[15px] resize-none overflow-hidden"
...
function MessageBubble({
    ...
    return (
        <motion.div
            ...
            className={clsx(
                "max-w-[80%] px-4 py-3 rounded-2xl my-1 relative",
        ...
        >
            <p className="text-[15px] leading-[22px]" style={{ color: isUser ? theme.buttonText : theme.text }}>
                {message.text}
            </p>
            <div
